...
if __name__ == '__main__':
    ...
    # chinese-xlnet-mid模型 
    # 指定模型名称，一键加载模型
    model = ppnlp.transformers.XLNetForSequenceClassification.from_pretrained(pretrained_model_name_or_path="chinese-xlnet-mid", num_classes=14)
    # 同样地，通过指定模型名称一键加载对应的Tokenizer，用于处理文本数据，如切分token，转token_id等
    tokenizer = ppnlp.transformers.XLNetTokenizer.from_pretrained(pretrained_model_name_or_path="chinese-xlnet-mid")
